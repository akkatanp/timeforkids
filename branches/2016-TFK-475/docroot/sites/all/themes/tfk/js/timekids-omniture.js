...
if(/(file:\/\/\/|localhost|v5\.timeinc\.net|timedev|qa-app\.timeforkidsdigital.com|timeforkids\.dev|dev\.timeforkids\.com|qa\.timeforkids\.com)/.test(location.href)){s_time_rsid2="timeglobalvideodev";}
...
s_time.linkInternalFilters="javascript:,timeforkids.com,timeinc.net,timeinc.com,customersvc.com,tfk.localhost";
...
/* TICM_omni cookie */
if((document.domain.indexOf('timeforkids.com')>-1)&&(typeof(s_time.eo)=='undefined')){
...
document.cookie='TICM_omni='+ escape(s_time.tcmval)+'; expires=; path=/; domain=timeforkids.com';}
...
mediaName=mediaFriendly + ' ' + videoMM+':'+videoSS;

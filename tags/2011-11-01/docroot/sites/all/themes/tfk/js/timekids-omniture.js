...
s_time.linkInternalFilters="javascript:,timeforkids.com,timeinc.net,timeinc.com,customersvc.com"
...
s_time.eVar27 = s_time.prop11;
s_time.eVar28 = s_time.prop15;
s_time.eVar35 = s_time.prop17;
s_time.eVar40 = s_time.prop13;
s_time.prop8 = s_time.getDaysSinceLastVisit('s_lv'); 
if(s_time.prop18){
...
s_time.Media.autoTrack = true; 
// s_time.Media.playerName = "TFK Player";
s_time.Media.trackWhilePlaying = true;
// s_time.Media.trackSeconds = 15; // OR
s_time.Media.trackMilestones = "25,50,75";
// media monitor
var omniTracked50 = false;
s_time.Media.monitor = function (s_time,media){
if (media.event == "OPEN"){
s_time.Media.trackVars = "eVar6,eVar7,events";
s_time.Media.trackEvents = "event6"; // start
s_time.events = "event6";
s_time.eVar6 = media.name;
s_time.eVar7 = s_time.prop16 +": video";
s_time.Media.track(media.name);}
if ((!omniTracked50) && (media.percent >=50)){
s_time.Media.trackVars = "eVar6,eVar7,events";
s_time.Media.trackEvents = "event7"; // 50% complete
s_time.events = "event7";
s_time.eVar6 = media.name;
s_time.eVar7 = s_time.prop16 +": video";
s_time.Media.track(media.name);
omniTracked50 = true;}
...
s_time.Media.trackVars = "eVar6,eVar7,events";
s_time.Media.trackEvents = "event8"; // stop
s_time.events = "event8";
s_time.eVar6 = media.name;
s_time.eVar7 = s_time.prop16 +": video";
s_time.Media.track(media.name);
omniTracked50=false;}
...
/****************************** MODULES *****************************/
/* Module: Media */
s_time.m_Media_c="var m=s.m_i('Media');m.cn=function(n){var m=this;return m.s.rep(m.s.rep(m.s.rep(n,\"\\n\",''),\"\\r\",''),'--**--','')};m.open=function(n,l,p,b){var m=this,i=new Object,tm=new Date,a='',"
